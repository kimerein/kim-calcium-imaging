function plot_components_GUI_withopto_andBeh(C_df,Cn,f2,Ao,b2,Yk,Df,options,opto_stim,beh_resample,times)
...
%         end
    ...
    function plot_component(i)
       if i < nr
        ...
        subplot(3,2,[2,4,6]);
        if i <= nr
            plot(times,Yk(i,:)/Df(i),'linewidth',2); 
            hold all;
            plot(times,C_df(i,:),'linewidth',2);
